    ...
    <div class="view view-main">
      <div data-name="home" class="page">
        ...
        <div class="page-content">
          <!-- Formulario para seleccionar los productos y mandarlos a pedido.php -->
          <form method="POST" action="pedido.php">
                    ...
                    <div class="block">
                      ...
                      <table id="" class="display table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                          ...
                          // Se hace una consulta a la base de datos para obtener los productos de una categoría específica
                          ...
                          while ($resultado = $sql->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            // Generar opciones para la cantidad de productos
                            for ($i = 0; $i <= 10; $i++) {
            ...
            <!-- Botón para enviar los productos seleccionados en el formulario -->
