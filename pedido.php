...
<body>
  ...
  // Definir funciones de que nos serán utiles más adelante
            ...
            {
              require("connection.php");
                // Realizar la consulta para obtener el id del distribuidor relacionado con el producto
            ...
            {
              require("connection.php");
                // Realizar la consulta para obtener el nombre del distribuidor
