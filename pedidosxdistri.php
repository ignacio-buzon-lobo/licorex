    ...
    <div class="view view-main">
      <div data-name="home" class="page">
        ...
        <div class="block-title">PEDIDOS DEL DISTRIBUIDOR:</div>
              <!-- Datatable de los pedidos por distribuidor -->
...
// Se hace una consulta a la base de datos para obtener los datos del pedido para un determinado distribuidor y los ordena por la fecha de creacion descendente
...
while ($resultado = $sql->fetch(PDO::FETCH_ASSOC)) {
    ...
    // Añade un botón que al pinchar sobre él podemos ver los detalles del pedido
